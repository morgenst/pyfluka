...
def main(argv):
    ...
    parser.add_argument('--weights', '-w', nargs='+', default=1., required=False, type=float,
                        help='file weights; single value applied to all files or list of weights corresponding to\
                         input files')
